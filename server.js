            ...
            if (!room) {
                ...
                if (requestedSystem === 'vampirov6') {
                    ...
                    room=normalizeRoom({
                        ...
                        currentImage:null,gridConfig:normalizeGridConfig(),tokens:[],sharedMusic:[],sheets:{},rollHistory:[],profiles:{},cameraOrder:[],
                ...
                room = normalizeRoom({
                    ...
                    tokens: [], sharedMusic: [], sheets: {}, rollHistory: [], profiles: {}, cameraOrder: [],
                    musicState: { trackId: null, playing: false, position: 0, startedAt: null, loop: true },
                    players: {}, createdAt: Date.now(), updatedAt: Date.now()
                }, code);
                rooms[code] = room;
