# Mesa RPG Online — V19.3

Correção crítica do fluxo de criação/entrada de campanhas.

- Restaura a função de configuração WebRTC (`rtcConfig`) que havia sido removida por engano.
- A ausência/configuração incorreta de TURN nunca mais bloqueia a abertura de uma sala.
- Mantém a autorização persistente do Vampiro V6 da V19.2.
- Mantém Lobisomem 3ª Edição/Revisada em português e todas as demais funcionalidades da V19.2.
