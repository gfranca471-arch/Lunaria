# Mesa RPG Online V22 — Cloudflare + RealtimeKit

> Versão preparada para Cloudflare Containers e videochamada multiponto com Cloudflare RealtimeKit. A lógica existente de salas, mapa, fichas, dados e Socket.IO foi preservada; a mídia passa a priorizar RealtimeKit, com fallback para o WebRTC P2P anterior.

**Guia de implantação:** veja [`CLOUDFLARE_DEPLOY.md`](./CLOUDFLARE_DEPLOY.md).
